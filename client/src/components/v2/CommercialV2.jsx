...
import { Building2, Printer, Save, DollarSign, Package,Euro, FileText, Globe, CreditCard } from "lucide-react"
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          ...
          <div className="mb-8">
            <h2 className="text-lg font-semibold text-gray-700 mb-4 flex items-center">
              <FileText className="mr-2 h-5 w-5" /> Invoice Type
            </h2>
            <input
              type="text"
              value={type}
          ...
          <div className="mb-8">
            <h2 className="text-lg font-semibold text-gray-700 mb-4 flex items-center">
              <FileText className="mr-2 h-5 w-5" /> ACID Information
            </h2>
            <div>
          ...
          <div className="flex justify-end space-x-4">
            <button
              onClick={newCommercial}
              className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              <Save className="mr-2 h-5 w-5" /> Save Invoice
            </button>
          ...
          <ReactPrint
              ...
              content={() => ref.current}
              documentTitle="Commercial_Invoice"
            />
          </span>
          </div>
        </div>
      ...
      <div className="border-2 border-gray-800 mb-6">
        <h1 className="text-center font-bold text-xl py-2 bg-gray-100">{type}</h1>
      </div>
      ...
      <table className="w-full border-2 border-gray-800 mb-6">
        <thead>
        <tr>
            <td className="border-2 border-gray-800 p-2" colSpan="6">
